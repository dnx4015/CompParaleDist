...
Os resultados nos tempos de execução dos experimentos da primeira categoria, i.e. os programas com diretivas OpenMP sem otimizações, podem ser enxergados nas tabelas ~\ref{tab:corei5so} e ~\ref{tab:xeonso}: 
